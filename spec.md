# Template AI Spec _(spec.md — commit trước hạn chốt spec: 21:00 17/9, tại CP4 · quality bar chốt từ thời điểm nộp)_
...
- _Job executor:_ Học viên tự xem lại tài liệu slide bài giảng sau giờ lên lớp để chuẩn bị làm bài tập Lab.
- _Workflow hiện tại:_
